...
const binp = path.join(cargoDir, "bin", "hello-world-rs");

if (fs.existsSync(binp)) {
  console.log("Uninstalling hello-world-rs...");
  exec(`cargo uninstall hello-world-rs`, (error, stdout, stderr) => {
    console.log(stdout);
    if (error || stderr) {
  ...
  console.log("hello-world-rs not found skipping!");
}
